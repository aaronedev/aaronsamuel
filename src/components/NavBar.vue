<template>
	<nav
		class="fixed left-0 top-0 z-50 w-full bg-slate-950 text-text-primary shadow-lg"
	>
		<div class="container mx-auto flex items-center justify-between p-4">
			<!-- Logo or Brand Name -->
			<div class="text-xl font-bold">
				<a href="#" class="text-accent-blue hover:underline">My Portfolio</a>
			</div>
			...
			<div class="flex items-center space-x-4">
				...
				<div>
					<label for="themeToggle" class="flex cursor-pointer items-center">
						<div class="relative flex items-center">
							...
							/>
							<div
								class="flex h-6 w-10 items-center rounded-full bg-gray-400 shadow-inner"
							/>
							<div
